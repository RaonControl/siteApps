...
/* Generated from ../O.Common/HPE3631Atest.dbd */
...
int HPE3631Atest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/HPE3631A";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"HPE3631Atest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    HPE3631Atest_registerRecordDeviceDriver(*iocshPpdbbase);
}
